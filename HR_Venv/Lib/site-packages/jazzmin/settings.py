...
DEFAULT_SETTINGS: Dict[str, Any] = {
    ...
    "site_brand": "Merida TechMinds",

    # Logo to use for your site, must be present in static files, used for brand on top left
    "site_logo": "vendor/adminlte/img/mimg-removebg-preview.png",

    # Logo to use for your site, must be present in static files, used for login form logo (defaults to site_logo)
    "login_logo": 'vendor/adminlte/img/merida_logo-removebg-preview (1).png',
    ...
    "welcome_sign": "Welcome to the Merida TechMinds",

    # Copyright on the footer
    "copyright": "MeridaTechMinds Pvt Ltd",
